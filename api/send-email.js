    ...
    body: JSON.stringify({
      ...
      html: `
        <div style="font-family: 'Georgia', serif; max-width: 520px; margin: 0 auto; padding: 40px 24px; background: #F5F1EC; color: #2C2420;">
          <h1 style="font-size: 28px; font-weight: 500; margin-bottom: 8px;">Welcome to Get Grounded</h1>
          ...
          <p style="font-size: 15px; color: #6B5E56; line-height: 1.65; margin-bottom: 32px;">
            Your reflections are confidential and only visible to you. Come back anytime.
          </p>
          ...
          <p style="font-size: 12px; color: #A0948A; margin-top: 40px; line-height: 1.6;">
